...
Public Class AdmitPatientReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Hospital_Management_System.AdmitPatientReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAdmitPatientReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AdmitPatientReport = New AdmitPatientReport()
        rpt.Site = Me.Site
        Return rpt
    End Function

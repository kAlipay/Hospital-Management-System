...
Public Class PatientDischargeReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "PatientDischargeReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Hospital_Management_System.PatientDischargeReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_srat_date() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedPatientDischargeReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PatientDischargeReport = New PatientDischargeReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
